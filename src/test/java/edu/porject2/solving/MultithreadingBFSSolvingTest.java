...
import edu.project2.solving.bfs.MultithreadedBFSSolver;
...
public class MultithreadingBFSSolvingTest {
    ...
    void bfsSquareSolving() {
        ...
        assertThat(extractPathByString("""
            ...
            ██▓▓▓▓▓▓██
            ██████▓▓██""", 5, 5))
            .hasSameElementsAs(new MultithreadedBFSSolver().solve(maze, maze.getEntrance(), maze.getExit()));
