...
public class AdditionTest {
    ...
    void additionEvaluate() {
        ...
        Assertions.assertEquals(
            -200 + (-200),
            new Expr.Addition(new Expr.Constant(-200), new Expr.Constant(-200)).evaluate()
        );
        Assertions.assertEquals(
        ...
        Assertions.assertEquals(
            ...
            new Expr.Addition(new Expr.Constant(Double.MIN_VALUE), new Expr.Constant(Double.MAX_VALUE)).evaluate()
        );
        Assertions.assertEquals(
            Double.MAX_VALUE + Double.MAX_VALUE,
            new Expr.Addition(new Expr.Constant(Double.MAX_VALUE), new Expr.Constant(Double.MAX_VALUE)).evaluate()
        );
        Assertions.assertEquals(
            Double.MIN_VALUE + Double.MIN_VALUE,
            new Expr.Addition(new Expr.Constant(Double.MIN_VALUE), new Expr.Constant(Double.MIN_VALUE)).evaluate()
        );
    }
}
